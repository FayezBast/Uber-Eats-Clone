...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-float hover:-translate-y-0.5 hover:bg-primary/92 hover:shadow-glow",
        secondary: "bg-secondary/90 text-secondary-foreground hover:bg-secondary/80",
        outline:
          "border border-border/80 bg-white/78 text-foreground shadow-sm hover:border-primary/35 hover:bg-surface/85",
        ghost: "text-foreground hover:bg-secondary/80",
        subtle: "bg-white/74 text-foreground shadow-sm hover:bg-white"
      },
      size: {
        default: "h-11 px-5",
        sm: "h-9 px-4 text-sm",
