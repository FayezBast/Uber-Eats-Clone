...
const sheetVariants = cva(
  "fixed z-50 bg-card p-6 shadow-glow transition ease-in-out border border-border",
  {
    variants: {
      side: {
        top: "inset-x-4 top-4 rounded-[28px]",
        bottom: "inset-x-4 bottom-4 rounded-[28px]",
        left: "inset-y-4 left-4 h-auto w-[92vw] max-w-md rounded-[32px]",
        right: "inset-y-4 right-4 h-auto w-[92vw] max-w-md rounded-[32px]"
      }
    },
    defaultVariants: {
      side: "right"
